	...
	<div class="bg-img">
		<div style="height: 100px;"></div>
  		<form action="module/login/login.php" method="post" class="login">
			...
			<div>
				<label style="color: lightgray">如果你沒有學號也沒關係，按下GO以後，系統會自動幫你產出一組序號。喔還有！別忘了要記下這組序號，因為它是你接下來在西灣的通行碼唷～ If you don't have a student ID, don't worry, after you click the "GO" button, the system will automatically generate a unique serial number for you. BTW, DON'T FORGET IT, because it's your passcode in SIWAN~</label>
			</div>
  		</form>
	</div>
</body>
