...
echo '<div class="border style="padding: 5px">Hey! '.$name.'. This is your own SIWAN PASS.<br>After you complete one mission, DON\'T forget to show the QR Code on this pass to the staff, and then you will receive one point. The more mission you complete, the more points you get.<br>If you need any assistance, feel free to ask for help~ (English is available!)</div>';
echo '<div class="border" style="padding: 5px">嗨！'.$name.'。這是你獨一無二的西灣通行證。<br>當你完成一關後，別忘了出示這上面的QR Code讓關主幫你掃碼積點，完成越多關就能獲得越多點數唷！<br>如果在過程中需要任何協助，儘管告訴我們，我們都很樂意幫助你唷～</div>';
